...
export default async function Page() {
  ...
  <div className="checkboxes">
      <label>
          <input type="checkbox" name="publicNote"/>Public
      </label>
      <label>
          <input type="checkbox" name="privateNote"/>Private Note
      </label>
      <label>
  ...
  <div className="note">
      <p>I love it...</p>
      <div className="topic">
          <textarea>"Lorem ipsum, this is the quote efiwojfweoifjwe feiwojfwe"</textarea>
          <p>Topic 1, Item 2 ---</p>
      </div>
      <div className="edit-buttons">
